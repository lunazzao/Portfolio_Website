      ...
      <div className="hero--section--content--box about--section--box">
        <div className="hero--section--content">
          ...
          <p className="hero--section-description">
            Hi! My name is Luna and I consider myself to be a future full-stack
          ...
          <p className="hero--section-description">
            As I look forward to the next step in my career, I am eager to find
            a role where I can continue to grow and develop as a full-stack
            software engineer. I thrive in environments that foster teamwork,
            collaboration, and mentorship, and I am excited about the
            opportunity to apply my knowledge and skills to contribute to your
            team while learning from experienced professionals in the field.
          </p>
        </div>
      </div>
    </section>
